...
import Flip_hover_data from "./Flip_hover_data";
import Three_cards_component_data from "./Three_cards_component_data";
import Client_component_data from "./Client_component_data";
import Call_component from "./Call_component";
import Pricing_component_data from "./Pricing_component_data";
import Tabbing_component from "./Tabbing_component";
import Counter_component from "./Counter_component";
import Newsletter_component from "./Newsletter_component";
import Contactform_component from "./Contactform_component";
import Blog_component_data from "./Blog_component_data";
